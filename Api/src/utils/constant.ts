...
export const PUBLIC_SALE_CONTRACT_ADDRESS = process.env.PUBLIC_SALE_CONTRACT_ADDRESS

export const PRIVATE_SALE_CONTRACT_ADDRESS = process.env.PRIVATE_SALE_CONTRACT_ADDRESS