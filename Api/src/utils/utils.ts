...
export const logger = winston.createLogger({
  ...
  transports: [
    ...
    new winston.transports.File({
      filename: 'logs/sendBulkToken_error.log',
      level: 'error',
    }),
    new winston.transports.File({
      filename: 'logs/sendBulkToken_info.log',
      level: 'info',
    }),
    new winston.transports.File({
      filename: 'logs/sendBulkToken_warn.log',
      level: 'warn',
    }),
...
export function isInwWhaleDisabledCollections(
...
const getOldTokenOwner = async (api: any, contractAddress: any) => {
  try {
    ...
    console.log('Error: can not get token owner');
    console.log(error);
  }
};
