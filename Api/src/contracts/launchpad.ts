...
export const launchpad_contract =
  process.env.IS_MAINNET == 'true'
    ? {
        ...
        CONTRACT_ABI: {
          "source": {
            "hash": "0x07c69eb711394ef9c759be8fc9208558e8b4e40a22ca0a572c2e84d4a9b9d806",
            "language": "ink! 4.3.0",
          ...
          spec: {
            ...
            messages: [
              ...
              },
              {
                ...
                docs: [],
                label:
                  'LaunchpadContractTrait::get_whitelist_sale_total_amount',
                mutates: false,
                payable: false,
                returnType: {
                  displayName: ['ink', 'MessageResult'],
              ...
              },
              {
                ...
                docs: [],
                label:
                  'LaunchpadContractTrait::get_public_sale_total_claimed_amount',
                mutates: false,
                payable: false,
                returnType: {
                  displayName: ['ink', 'MessageResult'],
