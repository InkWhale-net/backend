 ...
 */
declare const getContractAddress: (
 ...
 */
declare const resolveAddressToDomain: (
  address: string,
 ...
 */
declare const resolveDomainToAddress: (
  domain: string,
  options?: Partial<ResolveOptions>,
) => Promise<
  | {
